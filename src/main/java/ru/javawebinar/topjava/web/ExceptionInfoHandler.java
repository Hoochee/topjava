...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo bindError(HttpServletRequest req, Exception e) {
        ...
        String[] msg = result.getFieldErrors().stream()
                ...
                .toArray(String[]::new);
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, msg);
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... msg) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, msg.length != 0 ? msg : new String[]{ValidationUtil.getMsg(rootCause)});
    }
}